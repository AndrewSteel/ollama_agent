"""Config flow for Ollama-Agent integration."""
...
class OllamaAgentConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Ollama-Agent."""
    ...
    def async_get_options_flow(
        ...
        return OllamaAgentOptionsFlow(config_entry)


class OllamaAgentOptionsFlow(OptionsFlow):
    """Ollama options flow."""
    ...
    async def async_step_init(
        ...
        schema = ollama_agent_config_option_schema(self.hass, options)
        return self.async_show_form(
            step_id="init",
...
def ollama_agent_config_option_schema(
